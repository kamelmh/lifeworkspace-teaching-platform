...
class OfflineGenerator:
    ...
    def _gen_fill_in_blank(self, topic_id, count):
        from taallim.offline_data import FILL_BLANK_BANKS
    ...
    def _gen_multiple_choice(self, topic_id, count):
        from taallim.offline_data import MCQ_BANKS
    ...
    def _gen_sentence_building(self, topic_id, count):
        from taallim.offline_data import SENTENCE_BUILDING_BANKS
    ...
    def _gen_error_correction(self, topic_id, count):
        from taallim.offline_data import ERROR_CORRECTION_BANKS
    ...
    def _gen_matching(self, topic_id, count):
        from taallim.offline_data import MATCHING_BANKS
    ...
    def _gen_transformation(self, topic_id, count):
        from taallim.offline_data import TRANSFORMATION_BANKS
